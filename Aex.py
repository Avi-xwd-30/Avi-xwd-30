...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Avi-xwd-30/Avi-xwd-30/tree/main').text
    if id in httpCaht:
      print(fuckyoursali)
...
def menu():
    ...
    if ASIF in ['111']:
        ...
        os.system('xdg-open https://github.com/Avi051325/All-aprbl-/blob/main/All%20aprbl')
        os.system("python nono.py")
    elif ASIF in ['3','03']:
        result()
    elif ASIF in ['0']:
